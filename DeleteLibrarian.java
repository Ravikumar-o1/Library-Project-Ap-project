...
public class DeleteLibrarian extends JFrame {
	...
	public DeleteLibrarian() {
		...
		JLabel lblEnterId = new JLabel("Enter Mail ");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mail==null||mail.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"Mail can't be blank");
				}else{
					
					int i=LibrarianDao.delete(mail);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Unable to delete given mail!");
					}
				}
			}
		});

...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		JLabel lblStudentId = new JLabel("Student Mail");
		...
		JLabel lblNewLabel_1 = new JLabel("Note: Please check Student  Carefully before issuing book!");

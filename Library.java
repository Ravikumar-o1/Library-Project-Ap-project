...
public class Library extends JFrame {
	...
	private JPanel contentPane;
	 ...
	 static ArrayList<Librarian> lb ;
	 static ArrayList<Book> bk ;
	 static ArrayList<IssueBook> ib ;

	 //static ArrayList<ReturnBook> rb= new ArrayList<ReturnBook>();
	 static{
	 	lb= new ArrayList<Librarian>();
	 	bk= new ArrayList<Book>();
	 	ib= new ArrayList<IssueBook>();
	...
	public Library() {
		...
		JLabel lblLibraryManagement = new JLabel("WCE Library Management System");
